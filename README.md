This repository's goal is to compare and contrast various machine learning models (both supervised and unsupervised).
Each Jupiter Notebokk is a careful analysis of a specific model.
